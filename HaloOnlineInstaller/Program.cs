...
namespace Updater
{
    class Program
    {
        static void Main()
        {
            ...
            dynamic dew = JsonConvert.DeserializeObject(wc.DownloadString("http://thetwist84.github.io/HaloOnlineModManager/basegame/base.json")); MegaApiClient client = new MegaApiClient();
